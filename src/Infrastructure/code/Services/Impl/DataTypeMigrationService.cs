...
namespace Umbraco.Community.NestedContentConverter.Infrastructure.Services.Impl
{
    ...
    internal sealed class DataTypeMigrationService : IDataTypeMigrationService
    {
        ...
        public DataTypeMigrationService(ILogger<DataTypeMigrationService> logger, IDataTypeService dataTypeService, IDataTypeMigrationRepository repository, IRenamingService renamingService, IScopeProvider scopeProvider)
        {
            this.logger = logger;
        ...
        {
            using (this.scopeProvider.CreateScope(autoComplete: true))
            {
